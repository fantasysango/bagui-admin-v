var arrConfig = [
	...
	{ group: '', groupName: '', dataIndex: 'deptId', title: '部门ID', formType: '下拉框SP', dataType: '', default: '', options: 'dynamic', dictUrl: '/dept/list', dictLabel: 'name', dictValue: 'id', displayInTab: '否', displayInQuery: '是', displayInAdd: '否', max: '', min: '' },
	{ group: '', groupName: '', dataIndex: 'roleId', title: '角色ID', formType: '下拉框SP', dataType: '', default: '', options: 'dynamic', dictUrl: '/role/list', dictLabel: 'name', dictValue: 'id', displayInTab: '否', displayInQuery: '', displayInAdd: '否', max: '', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'sort', title: '排序', formType: '', dataType: 'int', default: '', options: '0', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '99', min: '1' },
	...
	{ group: '', groupName: '', dataIndex: 'permissionIds', title: '权限ID列表', formType: '', dataType: 'string[]', default: '', options: 'dynamic', dictUrl: 'XXX', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'parentId', title: '上级部门ID', formType: '下拉框SP', dataType: '', default: '', options: 'dynamic', dictUrl: '/dept/list', dictLabel: 'name', dictValue: 'id', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '36', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'purposeCode', title: '车辆用途', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'CAR_PURPOSE', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	{ group: '', groupName: '', dataIndex: 'configModeCode', title: '配置类型', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'CAR_CONFIG_MODE', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	{ group: '', groupName: '', dataIndex: 'useTypeCode', title: '使用类型', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'CAR_USE_TYPE', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	{ group: '', groupName: '', dataIndex: 'fundsSourceCode', title: '资金来源', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'CAR_FUNDS_SOURCE', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'managingRelationshipsCode', title: '管理关系', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'CAR_MANAGING_RELATIONSHIPS', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	{ group: '', groupName: '', dataIndex: 'managingRelationshipsValue', title: '管理关系', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'CAR_MANAGING_RELATIONSHIPS', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'carId', title: '车辆ID', formType: '下拉框SP', dataType: '', default: '', options: 'dynamic', dictUrl: '/car/list', dictLabel: 'number', dictValue: 'id', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	{ group: '', groupName: '', dataIndex: 'carNumber', title: '车牌号', formType: '下拉框SP', dataType: '', default: '', options: 'dynamic', dictUrl: '/car/list', dictLabel: 'number', dictValue: 'id', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'gasolineCardTypeValue', title: '油卡类型', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'GASOLINECARD_TYPE', displayInTab: '', displayInQuery: '', displayInAdd: '', max: 'YYYY-MM-DD', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'dispatchTypeCode', title: '派车单类型', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'DISPATCH_TYPE', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	{ group: '', groupName: '', dataIndex: 'dispatchTypeValue', title: '派车单类型', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'DISPATCH_TYPE', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'amount', title: '金额', formType: '', dataType: 'float', default: '', options: '', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'trainingTypeCode', title: '培训类型', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'TRAINING_TYPE', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	{ group: '', groupName: '', dataIndex: 'trainingTypeValue', title: '培训类型', formType: '下拉框', dataType: '', default: '', options: '', displayInTab: '', displayInQuery: '', displayInAdd: '否', max: '', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'travelDate', title: '出差日期', formType: 'rangepicker', dataType: '', default: '', options: '', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'paymentTypeCode', title: '支付类型', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'PAYMENT_TYPE', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	{ group: '', groupName: '', dataIndex: 'paymentTypeValue', title: '支付类型', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'PAYMENT_TYPE', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'communicationTypeCode', title: '通讯类型', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'COMMUNICATION_TYPE', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	{ group: '', groupName: '', dataIndex: 'communicationTypeValue', title: '通讯类型', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'COMMUNICATION_TYPE', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'entertainmentTypeCode', title: '招待类型', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'ENTERTAINMENT_TYPE', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	{ group: '', groupName: '', dataIndex: 'entertainmentTypeValue', title: '招待类型', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'ENTERTAINMENT_TYPE', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	...
	{ group: '', groupName: '', dataIndex: 'entertainmentNatureCode', title: '招待性质', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'ENTERTAINMENT_NATURE', displayInTab: '否', displayInQuery: '', displayInAdd: '', max: '', min: '' },
	{ group: '', groupName: '', dataIndex: 'entertainmentNatureValue', title: '招待性质', formType: '下拉框', dataType: '', default: '', options: 'dynamic', dictType: 'ENTERTAINMENT_NATURE', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '', min: '' },
