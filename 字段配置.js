var config = [
    ...
    { group: '', groupName: '', dataIndex: 'IsLeader', title: '是否是企业负责人', formType: '单选框', dataType: 'int', default: '', options: '0:否,1:是', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '', min: '' },
    { group: '', groupName: '', dataIndex: 'IsDeptManager', title: '是否是部门负责人', formType: '单选框', dataType: 'int', default: '', options: '0:否,1:是', displayInTab: '', displayInQuery: '', displayInAdd: '', max: '', min: '' },
